            ...
            <div className="form-section">
                ...
                <div className="form-group signature-area">
                    <div className="consent-text">
                        <h3>{t('registrationFormAdult.tnttCommitment')}</h3> {/* New title for student signature */}
                        <label>{t('registrationFormAdult.commitmentText')}</label> {/* New consent text for student */}
                    </div>
