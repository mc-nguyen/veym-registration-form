    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (data.payment) {
          ...
          setTotal(data.payment[1]*50 + data.payment[2]*25 + data.payment[3]*25 + data.payment[4]*10);
        }
        if (data) {
          setFormData({
      ...
      <div className="form-section">
        ...
        <div className="form-group">
          ...
          <input
            type="text"
            name="tenCha"
            value={formData.registration.tenCha || ""}
            onChange={(e) => handleChange(e, "registration")}
          />
        </div>
        <div className="form-group">
          ...
          <input
            type="text"
            name="tenMe"
            value={formData.registration.tenMe || ""}
            onChange={(e) => handleChange(e, "registration")}
          />
        </div>
        <div className="form-group">
          ...
          <input
            type="tel"
            name="phoneCha"
            value={formData.registration.phoneCha || ""}
            onChange={(e) => handleChange(e, "registration")}
          />
        </div>
        <div className="form-group">
          ...
          <input
            type="tel"
            name="phoneMe"
            value={formData.registration.phoneMe || ""}
            onChange={(e) => handleChange(e, "registration")}
          />
        </div>
        <div className="form-group">
        ...
        <div className="form-group signature-area">
          <div className="consent-text">
            <h3>{t("registrationForm.studentSignatureTitle")}</h3>{" "}
            {/* New title for student signature */}
            <label>
              {t("registrationForm.studentSignatureConsentText")}
            </label>{" "}
